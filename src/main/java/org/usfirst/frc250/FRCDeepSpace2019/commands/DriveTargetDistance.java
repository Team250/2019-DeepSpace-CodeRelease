...
/**TODO: Copy from working vision code
 *
 */
public class DriveTargetDistance extends Command {
    ...
    protected void initialize() {
        ...
        m_leftDist = Robot.vision.getCurrentDistance();
        m_rightDist = Robot.vision.getCurrentDistance();
        Robot.driveTrain.driveDistance(m_leftDist, m_rightDist);
    }
